...
export default function Contact() {
  ...
  const socials = [
    { label: 'Instagram', value: '@ramesh_suha', href: 'https://instagram.com/ramesh_suha', icon: 'instagram' },
    { label: 'LinkedIn', value: 'linkedin', href: 'https://linkedin.com/in/suhasini-ramesh-be-mba', icon: 'linkedin' },
    { label: 'GitHub', value: 'github', href: 'https://github.com/rameshsuhasini', icon: 'github' },
    { label: 'Notion', value: 'portfolio', href: 'https://www.notion.so/Suhasini-Ramesh-Senior-Frontend-Developer-30324e1c168c80139674c3290711a100', icon: 'notion' }
  ];
  ...
  return (
    <section ref={ref} id="contact" className="min-h-screen flex flex-col">
      ...
      <motion.div
        ...
        className="flex-1 flex items-center justify-center py-32 contact-cta"
      >
      ...
      <motion.footer
        ...
        className="contact-footer py-16"
      >
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-6">
              {socials.map((social, index) => (
                <motion.a
                  ...
                  className="flex items-center gap-2 transition-colors duration-300 hover:text-[var(--accent-primary)]"
                >
